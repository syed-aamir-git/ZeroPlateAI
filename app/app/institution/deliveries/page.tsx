                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-stone-100 pb-4">
                  ...
                  <div className="shrink-0 text-left sm:text-right">
                    {d.courier ? (
                      ...
                      <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-mono bg-emerald-50 text-emerald-900 border border-emerald-300 shadow-2xs">
                        <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                        <span className="font-semibold">Delivery Verified &amp; Completed</span>
                      </div>
                    ) : d.status === "delivered" ? (
                      <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-mono bg-emerald-50 text-emerald-900 border border-emerald-300 shadow-2xs">
                        <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                        <span className="font-semibold">Food Arrived at Shelter</span>
                      </div>
                    ) : d.status === "picked_up" ? (
                      <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-mono bg-blue-50 text-blue-900 border border-blue-200 shadow-2xs">
                        <Truck className="w-3.5 h-3.5 text-blue-600" />
                        <span className="font-semibold">Food In Transit to Site</span>
                      </div>
                    ) : d.status === "accepted" ? (
                      <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-mono bg-amber-50 text-amber-900 border border-amber-200 shadow-2xs">
                        ...
                        <span className="font-semibold">Driver Assigned · Heading to Kitchen</span>
                      </div>
                    ) : (
                      <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-mono bg-amber-50 text-amber-900 border border-amber-200 shadow-2xs">
                        <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
